...
-- Use actual ISBN-13 values for the real books added to reach a 50-book library total.
INSERT INTO `books` (`ISBN`, `BookTitle`, `Author`, `Edition`, `Year`, `Category`, `Reserved`) VALUES
...
('9780140449333', 'Les Miserables', 'Victor Hugo', 1, 1862, 8, 'N'),
('9780451526342', 'Animal Farm', 'George Orwell', 1, 1945, 8, 'N'),
('9780316769488', 'The Catcher in Rye', 'J.D. Salinger', 1, 1951, 8, 'N'),
('9781451673319', 'Fahrenheit 451', 'Ray Bradbury', 1, 1953, 8, 'N'),
('9780735211292', 'Atomic Habits', 'James Clear', 1, 2018, 6, 'N'),
('9780812981605', 'The Power of Habit', 'Charles Duhigg', 1, 2012, 6, 'N'),
...
('9780061122415', 'The Alchemist', 'Paulo Coelho', 1, 1988, 8, 'N'),
('9781594480003', 'The Kite Runner', 'Khaled Hosseini', 1, 2003, 8, 'N'),
('9780307387895', 'The Road', 'Cormac McCarthy', 1, 2006, 8, 'N'),
('9780062409850', 'The Body', 'Bill Bryson', 1, 2019, 1, 'N'),
('9781932100346', 'The Paleo Diet', 'Loren Cordain', 1, 2002, 1, 'N'),
('9780066620992', 'Good to Great', 'Jim Collins', 1, 2001, 2, 'N'),
('9780307887894', 'The Lean Startup', 'Eric Ries', 1, 2011, 2, 'N'),
('9780062273208', 'The Hard Thing', 'Ben Horowitz', 1, 2014, 2, 'N'),
('9780201835953', 'The Mythical Man-Month', 'Fred Brooks', 1, 1975, 4, 'N'),
('9780132350884', 'Clean Code', 'Robert C. Martin', 1, 2008, 4, 'N'),
('9780465050659', 'The Design of Everyday Things', 'Don Norman', 1, 1988, 4, 'N'),
('9780205309023', 'The Elements of Style', 'Strunk and White', 1, 1918, 4, 'N'),
('9780330288581', 'In a Sunburned Country', 'Bill Bryson', 1, 2000, 5, 'N'),
('9780767902529', 'A Walk in the Woods', 'Bill Bryson', 1, 1998, 5, 'N'),
('9780140449157', 'Around the World in 80 Days', 'Jules Verne', 1, 1873, 5, 'N'),
('9780142180538', 'The Art of Travel', 'Alain de Botton', 1, 2002, 5, 'N'),
('9781476753836', 'Salt, Fat, Acid, Heat', 'Samin Nosrat', 1, 2017, 7, 'N'),
('9780307574923', 'The Joy of Cooking', 'Irma S. Rombauer', 1, 1931, 7, 'N'),
('9781400052307', 'The Immortal Life', 'Rebecca Skloot', 1, 2010, 3, 'N'),
